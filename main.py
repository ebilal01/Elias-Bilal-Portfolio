...
origins = [
    ...
    "https://elias-bilal-portfolio-4.onrender.com",  # Add your Render frontend origin here
    "http://elias-bilal-portfolio-4.onrender.com",
    "https://elias-bilal-portfolio-5.onrender.com"   # Add the HTTP version if needed
]
...
@app.post("/lungcancer")
async def lung_cancer_prediction(data: LungCancerData):
    ...
    try:
        ...
        city = data.city# Rest of your code here using the retrieved values
        ...
        if row == 0:
            ...
            result =result = JSONResponse(content={"message": answer})
        else:
            average = Total / row
            if average < 1.5:
