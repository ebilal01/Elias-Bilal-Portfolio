...
origins = [
    ...
    "http://elias-bilal-portfolio-25.onrender.com",
    "https://elias-bilal-portfolio-25.onrender.com"   # Add the HTTP version if needed
]
...
@app.post("https://elias-bilal-portfolio-25.onrender.com/submit")
async def submit_form(data: LungCancerData):
    try:
        print("Received form data:", data)

        # Access form data
        gender = int(data.get('gender'))
        alcohol_use = int(data.get('alcohol_use'))
        smoking_level = int(data.get('smoking_level'))
        city = data.get('city')

        # Now you can use these variables
        print("Alcohol Use:", alcohol_use)
        print("Smoking:", smoking_level)
        print("Gender:", gender)
        print("City:", city)
