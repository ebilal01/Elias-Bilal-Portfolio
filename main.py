...
templates_dir = "https://ebilal01.github.io"
...
filename = 'https://raw.githubusercontent.com/ebilal01/Elias-Bilal-Portfolio/main/static/data/cancer%20patient%20data%20sets.csv'

patient_df = pd.read_csv(filename, encoding="ISO-8859-1", index_col=0)

dilename = 'https://raw.githubusercontent.com/ebilal01/Elias-Bilal-Portfolio/main/static/data/cities_air_quality_water_pollution.18-10-2021.csv'
...
async def get_lungcancer_form():
    return RedirectResponse("https://raw.githubusercontent.com/ebilal01/Elias-Bilal-Portfolio/main/static/lungcancer.html")

@app.post("/Elias-Bilal-Portfolio/lungcancer")
async def lung_cancer_prediction(request: Request, gender: int = Form(...), alcohol_use: int = Form(...), smoking_level: int = Form(...), city: str = Form(...)):
    try:
