...
origins = [
    ...
    "http://elias-bilal-portfolio-27.onrender.com",
    "https://elias-bilal-portfolio-27.onrender.com"   # Add the HTTP version if needed
]
...
async def get_homepage():
    async with aiohttp.ClientSession() as session:
        async with session.get("https://elias-bilal-portfolio-27.onrender.com/") as resp:
...
async def submit_form(data: LungCancerData = Body(...)):
    try:
        ...
        if row3 == 0:
            ave = (Total2/row2)
            print (filter2_df["Level"])
            preanswer = "No similar patient data available for your gender and the airquality of your city but based on the factors of Smoking Level, Alcohol Use:"
