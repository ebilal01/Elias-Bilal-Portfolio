...
templates_dir = "https://ebilal01.github.io/Elias-Bilal-Portfolio"
templates = Jinja2Templates(directory=templates_dir)

app = FastAPI()

app.mount("/static", StaticFiles(directory="https://ebilal01.github.io/Elias-Bilal-Portfolio/static"), name="static")

origins = ["*", "https://ebilal01.github.io/Elias-Bilal-Portfolio"]
app.add_middleware(
    CORSMiddleware,
...
filename = 'https://ebilal01.github.io/Elias-Bilal-Portfolio/static/data/cancer%20patient%20data%20sets.csv'
patient_df = pd.read_csv(filename, encoding="ISO-8859-1", index_col=0)

# defines the csv file as a variable
dilename = 'https://ebilal01.github.io/Elias-Bilal-Portfolio/static/data/cities_air_quality_water_pollution.18-10-2021.csv'
...
pd.set_option('display.max_rows', 10)
        ...
        # defines the csv file as a variable
        # h: the file doesnt have underscores 
...
plt.savefig("Air_Qual_prob.png")
plt.close()


@app.post("/lungcancer.html", response_class=JSONResponse)
async def lung_cancer_prob(request: Request, gender: int = Form(...), alcohol_use: int = Form(...), smoking_level: int = Form(...), city: str = Form(...)):
    try:
...
@app.get("/lungcancer.html", response_class=HTMLResponse)
async def get_lungcancer_page():
    file_path = os.path.join(templates_dir, "lungcancer.html")
