...
origins = [
    ...
    "http://elias-bilal-portfolio-23.onrender.com",
    "https://elias-bilal-portfolio-23.onrender.com"   # Add the HTTP version if needed
]
...
@app.post("https://elias-bilal-portfolio-23.onrender.com/submit")
