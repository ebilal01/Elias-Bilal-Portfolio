...
origins = [
    ...
    "http://elias-bilal-portfolio-20.onrender.com",
    "https://elias-bilal-portfolio-20.onrender.com"   # Add the HTTP version if needed
]
...
@app.post("/submit")
async def submit_form(gender: int = Form(...), alcohol_use: int = Form(...), smoking_level: int = Form(...), city: str = Form(...)):
    try:
