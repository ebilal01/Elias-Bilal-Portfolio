...
origins = [
    ...
    "http://elias-bilal-portfolio-13.onrender.com",
    "https://elias-bilal-portfolio-13.onrender.com"   # Add the HTTP version if needed
]
...
async def submit_form(data: dict = Body(...)):
    try:
        ...
        smoking_level = data.get('smoking_level')
        city = data.get('city')
