...
templates_dir = "D:\\Elias Backup\\Documents\\Engineering Portfolio"
templates = Jinja2Templates(directory=templates_dir)

app = FastAPI()

app.mount("/static", StaticFiles(directory="D:/Elias Backup/Documents/Engineering Portfolio/static"), name="static")
