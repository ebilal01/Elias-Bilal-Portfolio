...
origins = [
    ...
    "http://elias-bilal-portfolio-1.onrender.com",
    "https://elias-bilal-portfolio-1.onrender.com"   # Add the HTTP version if needed
]
...
async def get_homepage():
    async with aiohttp.ClientSession() as session:
        async with session.get("https://elias-bilal-portfolio-1.onrender.com/") as resp:
